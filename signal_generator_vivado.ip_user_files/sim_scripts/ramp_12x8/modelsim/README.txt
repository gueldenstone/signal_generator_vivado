...
#
# Generated by export_simulation on Tue Dec 15 17:25:17 CET 2020
#
################################################################################
...
'-reset_run' switch to the './ramp_12x8.sh' script.

./ramp_12x8.sh -reset_run
...
./ramp_12x8.sh -noclean_files

For more information on the script, please type './ramp_12x8.sh -help'.
