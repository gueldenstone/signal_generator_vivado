...
#
# Generated by export_simulation on Sun Dec 13 16:05:26 CET 2020
#
################################################################################
...
'-reset_run' switch to the './btn_tim_1.sh' script.

./btn_tim_1.sh -reset_run
...
./btn_tim_1.sh -noclean_files

For more information on the script, please type './btn_tim_1.sh -help'.
