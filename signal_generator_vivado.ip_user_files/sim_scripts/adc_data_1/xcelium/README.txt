...
#
# Generated by export_simulation on Thu Dec 10 17:00:57 CET 2020
#
################################################################################
...
'-reset_run' switch to the './adc_data_1.sh' script.

./adc_data_1.sh -reset_run
...
./adc_data_1.sh -noclean_files

For more information on the script, please type './adc_data_1.sh -help'.
