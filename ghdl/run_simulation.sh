...
ghdl -i signal_generator_vivado.srcs/sources_1/imports/new/signal_generator.vhd \
signal_generator_vivado.srcs/sources_1/imports/new/lut.vhd \
signal_generator_vivado.srcs/sources_1/imports/new/counter.vhd \
signal_generator_vivado.srcs/sources_1/imports/new/clock_divider.vhd \
